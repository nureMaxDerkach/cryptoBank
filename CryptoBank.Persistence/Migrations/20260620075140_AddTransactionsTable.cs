        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromAmount = table.Column<decimal>(type: "decimal(38,18)", nullable: false),
                    ToCurrencyId = table.Column<long>(type: "bigint", nullable: false),
                    ToAmount = table.Column<decimal>(type: "decimal(38,18)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Currencies_FromCurrencyId",
                        column: x => x.FromCurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_Currencies_ToCurrencyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_FromCurrencyId",
                table: "Transactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ToCurrencyId",
                table: "Transactions",
                column: "ToCurrencyId");
